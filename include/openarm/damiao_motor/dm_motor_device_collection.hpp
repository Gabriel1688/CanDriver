...
public:
    DMDeviceCollection(CANSocket& can_socket);
    ...
    CANDeviceCollection& get_device_collection() { return *device_collection_; }
...
protected:
    ...
    std::unique_ptr<CANDeviceCollection> device_collection_;
